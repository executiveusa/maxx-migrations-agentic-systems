# AGENTS.md — Cheggie Media

## Purpose

Digital media agency based in Serbia, operating within the 6-agency Maxx
...
- `maxx_organizations` row: slug `cheggie-media`, plan `sovereign_install`
...
- Agents operating under this org see only `cheggie-media`-scoped rows in
  every `maxx_`-prefixed table
- If client-facing copy is needed in Serbian, do not machine-translate
  English brand voice — draft directly in the target language once brand
...
- Track bead progress and agent sessions specific to Cheggie Media projects
...
requirements, and project history for Cheggie Media were not provided at
the time this file was generated. Update this file with the actual brand
