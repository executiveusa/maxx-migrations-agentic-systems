...
export const metadata: Metadata = {
  title: "MACS Digital Media — Find the Bottleneck Before You Build",
  description: "MACS diagnoses the business systems costing you time or money, then recommends the highest-value fix before another build.",
};
      ...
      <main id="main-content">
        <section className="mx-auto flex min-h-[78vh] max-w-7xl items-end px-5 py-20 md:px-8 md:py-28 lg:py-36">
          <div className="grid w-full gap-12 lg:grid-cols-[minmax(0,1.45fr)_minmax(220px,.55fr)] lg:items-end">
            ...
            <div className="hidden pb-3 lg:block">
              ...
              <p className="mt-5 max-w-[14rem] text-sm leading-6 text-muted">One front door. One paid first step. No software pitch before diagnosis.</p>
            </div>
          </div>
        </section>
        ...
        <section id="system" className="bg-surface py-24 md:py-36">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            ...
            <h2 className="mt-6 max-w-5xl font-display text-5xl font-semibold leading-[0.98] tracking-[-0.045em] md:text-7xl">Diagnose first. Build only what earns its place.</h2>
        ...
        <section id="work" className="bg-[#0f3428] py-24 text-[#f6f3ec] md:py-36">
          <div className="mx-auto grid max-w-7xl gap-16 px-5 md:px-8 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
            ...
            <div>
              <h2 className="font-display text-5xl font-semibold leading-[0.96] tracking-[-0.045em] md:text-7xl">MACS had the same problem we sell against.</h2>
              <p className="mt-8 max-w-2xl text-lg leading-8 text-[#d8e3df]">Too much interface, too much offer language, and no durable company-intake operating layer. We reduced the problem into one governed onboarding system before expanding the product.</p>
              <div className="mt-12 grid grid-cols-2 border-y border-white/25 md:grid-cols-4">
                {[["116", "structured questions"], ["83", "required decisions"], ["1", "ICM company brain"], ["0", "fake proof claims"]].map(([value, label]) => (
              ...
              <p className="mt-7 max-w-2xl text-sm leading-6 text-[#a9bdb4]">Application build checks passed before merge. Live Supabase tenant-isolation and approval receipts remain a separate release gate and are not presented as completed proof.</p>
              <Link href="/work/macs-client-zero" className="mt-8 inline-block border-b border-[#a9d7c4] pb-1 text-sm font-bold text-[#a9d7c4]">Read the Client Zero case study</Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 md:py-36">
          <div className="mx-auto grid max-w-7xl gap-14 px-5 md:px-8 lg:grid-cols-[.75fr_1.25fr] lg:gap-20">
            <div>
              ...
              <h2 className="mt-6 font-display text-5xl font-semibold leading-[0.98] tracking-[-0.045em] md:text-7xl">Systems your business can use and own.</h2>
            </div>
        ...
        <section id="about" className="bg-surface py-24 md:py-36">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            ...
            <h2 className="mt-6 max-w-5xl font-display text-5xl font-semibold leading-[0.98] tracking-[-0.045em] md:text-7xl">For owners with a real operating problem. Not people shopping for an AI toy.</h2>
            <div className="mt-14 grid gap-10 md:mt-20 md:grid-cols-2 md:gap-14">
              <div className="border-t border-text pt-7">
                ...
                <ul className="mt-6 space-y-4 text-base leading-7 text-muted"><li>Leads, time or visibility are being lost between tools.</li><li>The team repeats manual work every week.</li><li>You want AI with human control, evidence and explicit authority.</li><li>You want control of the delivered system and an exit path.</li></ul>
              </div>
              <div className="border-t border-text pt-7">
                <h3 className="font-display text-3xl font-semibold">Not a fit</h3>
                <ul className="mt-6 space-y-4 text-base leading-7 text-muted"><li>You want a generic chatbot with no measurable business outcome.</li><li>You want working systems replaced before diagnosis.</li><li>You want automation designed to bypass approvals or ownership.</li><li>You will not let the audit inspect the real workflow or available evidence.</li></ul>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 md:py-36">
          <div className="mx-auto max-w-7xl px-5 md:px-8">
            ...
            <h2 className="mt-6 max-w-5xl font-display text-5xl font-semibold leading-[0.98] tracking-[-0.045em] md:text-7xl">You tell us the outcome. We do the investigation.</h2>
            <div className="mt-16 border-b border-border md:mt-24">
        ...
        <section className="flex min-h-[66vh] items-center border-t border-border py-24 text-center md:py-36">
          <div className="mx-auto max-w-6xl px-5 md:px-8">
            ...
            <h2 className="mx-auto mt-7 max-w-5xl font-display text-5xl font-semibold leading-[0.96] tracking-[-0.05em] md:text-7xl lg:text-8xl">Before we build you anything, let&apos;s find out what is actually worth fixing.</h2>
            <Link href="/audit" data-event="audit_cta_click" className="mt-10 inline-flex rounded-full bg-accent px-7 py-4 text-sm font-bold text-white transition-transform duration-150 active:scale-[0.98]">Start the $497 Vibe Audit</Link>
          </div>
        </section>
      </main>
      <Footer />
