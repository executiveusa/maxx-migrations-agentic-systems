...
const topics = [
  { number: "01", category: "Spend less", title: "How many software subscriptions does a small business actually need?", summary: "A plain-English way to decide what to keep, cancel, consolidate or replace before another monthly charge lands." },
  { number: "02", category: "Automation", title: "Do not automate a broken process.", summary: "If the handoff is already confusing, automation usually makes the confusion move faster. Fix the path first." },
  { number: "03", category: "Ownership", title: "GoHighLevel or your own stack? Start with the kind of business you actually run.", summary: "All-in-one software can be useful. Ownership can be useful. The right answer depends on control, complexity and what you are trying to escape." },
  { number: "04", category: "AI without the hype", title: "AI is not just a chatbot anymore. Here is what changed for small business.", summary: "The useful shift is from asking AI questions to letting approved tools handle boring, repeatable digital work around a clear outcome." },
  { number: "05", category: "E-commerce", title: "UGC ads without the mystery: what a small Shopify store actually needs first.", summary: "Stavari breaks the process down into product, proof, hook, footage and one clear next action—without turning the owner into an ad technician." },
  { number: "06", category: "Business brain", title: "Get your business out of your head before you add more AI.", summary: "Organize the facts, offers, customers, rules and workflows people keep asking you for. Then the technology has something reliable to work from." },
];
...
export default function BlogPage() {
  return (
    <div className="marketing-shell min-h-screen bg-bg text-text"><MainNav /><main id="main-content">
      ...
      <section id="editorial-note" className="py-20 md:py-28"><Reveal className="mx-auto max-w-7xl px-5 md:px-8"><div className="grid gap-10 rounded-[2rem] bg-[#171b18] p-7 text-[#f7f3ea] md:p-10 lg:grid-cols-[.78fr_1.22fr] lg:gap-16"><div><p className="text-xs font-bold uppercase tracking-[0.14em] text-[#a9d7c4]">How MAXX Notes works</p><h2 className="mt-5 font-display text-4xl font-semibold leading-[0.98] tracking-[-0.04em] md:text-6xl">Real questions first. Articles second.</h2></div><div className="space-y-5 text-base leading-7 text-[#c7d2cd]"><p>We are seeding the editorial desk with customer problems: software cost, failed automation, AI confusion, ownership, Shopify, UGC and the questions local operators keep asking.</p><p>Drafts stay drafts until a human reviews the claims, usefulness and fit.</p></div></div></Reveal></section>
      <section className="border-t border-border py-20 text-center md:py-28"><Reveal className="mx-auto max-w-5xl px-5 md:px-8"><p className="text-xs font-bold uppercase tracking-[0.14em] text-accent">Have one of these problems now?</p><h2 className="mt-6 font-display text-5xl font-semibold leading-[0.96] tracking-[-0.05em] md:text-7xl">You do not have to become technical before asking for help.</h2><div className="mt-9 flex flex-wrap justify-center gap-4"><Link href="/maxx" className="inline-flex rounded-full border border-border px-7 py-4 text-sm font-bold">Meet Agent MAXX</Link><Link href="/audit" className="inline-flex rounded-full bg-accent px-7 py-4 text-sm font-bold text-white">Start the $497 Vibe Audit</Link></div></Reveal></section>
    </main><Footer /></div>
  );
}